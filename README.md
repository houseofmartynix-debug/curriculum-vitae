...
* **Enterprise Risk Mitigation:**
  ...
  * **$5,900 in bounty rewards** and **213 Bugcrowd researcher points**, all solo — **$2,600 / 80 points** on the Accxia Marketplace Bug Bounty engagement (headlined by a **P1 Critical** authorisation bypass), **$300 / 10 points** from Gliffy, and a further **$3,000** across additional Bugcrowd and Atlassian Data Center programmes withheld here under coordinated-disclosure terms.
  * **17 paid bounties across six separate programmes**, spanning P1 Critical through accepted-informational.
